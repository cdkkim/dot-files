...
"
" Author:       Kyeong Oh Kim <ruddhdlek@gmail.com>
" Reference:    https://github.com/dikiaap/minimalist
" Repository:   https://github.com/cdkkim/dot-files/
" Version:      1.0
" License:      MIT
...
hi Comment          ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#444444       guibg=NONE      gui=NONE
...
hi SpecialComment   ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#666666       guibg=NONE      gui=NONE
...
hi phpBoolean           ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#D7875F       guibg=NONE      gui=NONE " PHP
...
hi phpCommentStar       ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#444444       guibg=NONE      gui=NONE
hi phpCommentTitle      ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#444444       guibg=NONE      gui=NONE
hi phpDocComment        ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#444444       guibg=NONE      gui=NONE
hi phpDocIdentifier     ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#444444       guibg=NONE      gui=NONE
hi phpDocParam          ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#444444       guibg=NONE      gui=NONE
hi phpDocTags           ctermfg=243     ctermbg=NONE    cterm=NONE      guifg=#666666       guibg=NONE      gui=NONE
hi phpFunction          ctermfg=225     ctermbg=NONE    cterm=NONE      guifg=#5FAFD7       guibg=NONE      gui=NONE
hi phpFunctions         ctermfg=225     ctermbg=NONE    cterm=NONE      guifg=#5FAFD7       guibg=NONE      gui=NONE
" $this
hi phpIdentifier        ctermfg=231     ctermbg=NONE    cterm=NONE      guifg=#EEEEEE       guibg=NONE      gui=NONE
" use namespace
hi phpInclude           ctermfg=104     ctermbg=NONE    cterm=NONE      guifg=#AF87D7       guibg=NONE      gui=NONE
" function return
hi phpKeyword           ctermfg=104     ctermbg=NONE    cterm=NONE      guifg=#AF87D7       guibg=NONE      gui=NONE
" method call()
hi phpMethod            ctermfg=225     ctermbg=NONE    cterm=NONE      guifg=#5FAFD7       guibg=NONE      gui=NONE
...
" {} () []
hi phpParent            ctermfg=140     ctermbg=NONE    cterm=NONE      guifg=#87D7FF       guibg=NONE      gui=NONE
" ->
hi phpMemberSelector    ctermfg=163     ctermbg=NONE    cterm=NONE      guifg=#87D7FF       guibg=NONE      gui=NONE
" 
hi phpMethodsVar        ctermfg=104     ctermbg=NONE    cterm=NONE      guifg=#EEEEEE       guibg=NONE      gui=NONE
hi phpStaticClasses     ctermfg=215     ctermbg=NONE    cterm=NONE      guifg=#FFAF5F       guibg=NONE      gui=NONE
hi phpStringDouble      ctermfg=215     ctermbg=NONE    cterm=NONE      guifg=#AFD787       guibg=NONE      gui=NONE
hi phpStringDelimiter   ctermfg=222     ctermbg=NONE    cterm=NONE      guifg=#87D7FF       guibg=NONE      gui=NONE
hi phpStringSingle      ctermfg=222     ctermbg=NONE    cterm=NONE      guifg=#AFD787       guibg=NONE      gui=NONE
hi phpSuperglobals      ctermfg=222     ctermbg=NONE    cterm=NONE      guifg=#EEEEEE       guibg=NONE      gui=NONE
" public
hi phpType              ctermfg=104     ctermbg=NONE    cterm=NONE      guifg=#AF87D7       guibg=NONE      gui=NONE
" Illuminate\Database\Eloquent\Builder; 
hi phpUseClass          ctermfg=215     ctermbg=NONE    cterm=NONE      guifg=#FFAF5F       guibg=NONE      gui=NONE
" $
hi phpVarSelector       ctermfg=140     ctermbg=NONE    cterm=NONE      guifg=#87D7FF       guibg=NONE      gui=NONE
